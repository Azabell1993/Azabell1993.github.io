...
function displayResumeInfo(output) {
    ...
    insertRow(table, "2020.01.28 ~ 2020.10.16", "   나노에이스 | 금형설계 및 유지보수");
    insertRow(table, "2017.11.20 ~ 2020.01.24", "   두리엔     | 금형설계 및 유지보수");
    insertRow(table, "2014.08.13 ~ 2017.11.01", "   맥스킬     | 플랜트배관 설계 및 모델링");
